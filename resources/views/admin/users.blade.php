<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-8">
        <div class="mb-6 flex justify-between items-center">
            <div>
                <h1 class="text-2xl font-bold text-sigap-blue">Kelola User</h1>
                <p class="text-gray-600 mt-1">Daftar semua user dan pekerja</p>
            </div>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @foreach($users as $user)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="px-2 py-1 text-xs font-semibold rounded-full {{ $user->role == 'pekerja' ? 'bg-sigap-orange/10 text-sigap-orange' : 'bg-sigap-blue/10 text-sigap-blue' }}">
                                        {{ ucfirst($user->role) }}
                                    </span>
                                </td>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <a href="{{ route('admin.users.edit', $user) }}" class="text-sigap-orange hover:text-orange-600 mr-3">Edit</a>
