        ...
        <div class="max-w-md w-full space-y-8">
            <div>
                ...
                <p class="mt-2 text-center text-sm text-gray-600">
                    Atau
                    <a href="<?php echo e(route('login')); ?>" class="font-medium text-sigap-orange hover:text-orange-600">
...
unset($__errorArgs, $__bag); ?>">
                            ...
                            <option value="user" <?php echo e(old('role') == 'user' ? 'selected' : ''); ?>>User (Mencari Pekerja)</option>
                            <option value="pekerja" <?php echo e(old('role') == 'pekerja' ? 'selected' : ''); ?>>Pekerja SIGAP</option>
                        </select>
...
<?php /**PATH /home/fahmyzzx/sigap/resources/views/auth/register.blade.php ENDPATH**/ ?>