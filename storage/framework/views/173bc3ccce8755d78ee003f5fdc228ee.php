...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('title', null, []); ?> Dashboard Pekerja SIGAP <?php $__env->endSlot(); ?>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-8">
            ...
            <div class="card">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-sigap-blue mt-2"><?php echo e($myApplications->count()); ?></p>
                    </div>
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-yellow-600 mt-2">
                            <?php echo e($myApplications->where('status', 'pending')->count()); ?>
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-green-600 mt-2">
                            <?php echo e($myApplications->where('status', 'accepted')->count()); ?>
        ...
        <div class="card mb-8">
            <div class="flex justify-between items-center mb-6">
                ...
                <a href="<?php echo e(route('jobs.index')); ?>" class="text-sigap-orange hover:underline text-sm font-medium">
                    Lihat Semua →
                </a>
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <?php $__currentLoopData = $availableJobs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $job): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="border border-gray-200 rounded-lg p-4 hover:shadow-md transition">
                            ...
                            <p class="text-gray-600 text-sm mb-3"><?php echo e(Str::limit($job->description, 80)); ?></p>
                            ...
                            <a href="<?php echo e(route('jobs.show', $job)); ?>" class="btn-primary text-sm py-2 px-4 inline-block">
                                Lihat Detail
                            </a>
                        </div>
        ...
        <div class="card">
                    ...
                    <?php $__currentLoopData = $myApplications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $application): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="border border-gray-200 rounded-lg p-4 hover:shadow-md transition">
                            <div class="flex justify-between items-start">
                                <div class="flex-1">
                                    <h3 class="text-lg font-semibold text-sigap-blue mb-2">
                                        <a href="<?php echo e(route('jobs.show', $application->job)); ?>" class="hover:text-sigap-orange transition">
                                            <?php echo e($application->job->title); ?>

                                        </a>
                                    </h3>
                                    <p class="text-gray-600 text-sm mb-2"><?php echo e(Str::limit($application->job->description, 100)); ?></p>
                                    <div class="flex flex-wrap gap-2 text-sm">
                                        <span class="badge badge-secondary"><?php echo e($application->job->category); ?></span>
                                        <span class="badge badge-primary">Rp <?php echo e(number_format($application->job->budget, 0, ',', '.')); ?></span>
                                    </div>
                                </div>
                                <div class="ml-4 text-right">
                                    ...
                                    <?php endif; ?>
                                    <div class="mt-2">
                                        <a href="<?php echo e(route('jobs.show', $application->job)); ?>" class="text-sm text-sigap-orange hover:underline">
                                            Lihat Detail
                                        </a>
                                    </div>
                                </div>
            ...
            <?php else: ?>
                <div class="text-center py-12">
                    ...
                    <a href="<?php echo e(route('jobs.index')); ?>" class="btn-primary inline-block">
                        Jelajahi Pekerjaan
                    </a>
                </div>
            <?php endif; ?>
...
<?php /**PATH /home/fahmyzzx/sigap/resources/views/dashboard/pekerja.blade.php ENDPATH**/ ?>